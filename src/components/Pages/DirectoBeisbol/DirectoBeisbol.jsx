...
export default function DirectoBeisbol({getImages, dataDeport}) {
...
let itemDB = []
  ...
  return (
    <div className='home_layout'>
        <div style={{ backgroundImage: 'linear-gradient(160deg, #4D3E36 0%, #383838 400px)'}}>
            <TitleDirecto title='Béisbol' options={title_options}/>
            {itemDB.map((i,index) => {
